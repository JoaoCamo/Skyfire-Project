...
{
    public class StageClutterButton : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
    {
        ...
        {
            _isActive = PlayerPrefs.GetInt(STAGE_CLUTTER_KEY, 1) == 1;
        ...
        private void OnClick()
        {
            ...
            PlayerPrefs.SetInt(STAGE_CLUTTER_KEY, _isActive ? 1 : 0);
